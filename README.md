...
Provides the schemas used at LAP
...
```sh
git clone https://github.com/FAU-LAP/nomad-lap-schema.git
cd nomad-lap-schema
...
| Name | E-mail     |
|------|------------|
| Johannes Lehmeyer | [johannes.lehmeyer@fau.de](mailto:johannes.lehmeyer@fau.de)
